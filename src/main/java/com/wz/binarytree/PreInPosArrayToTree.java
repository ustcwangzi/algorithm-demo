 ...
 *         先序和中序重建二叉树：头节点为1，左子树节点为{2, 4, 5, 8, 9}、{4, 2, 8, 5, 9}，右子树节点为{3, 6, 7}、{6, 3, 7} ...
 *         中序和后序重建二叉树：头节点为1，左子树节点为{4, 2, 8, 5, 9}、{4, 8, 9, 5, 2}，右子树节点为{6, 3, 7}、{6, 7, 3} ...
 *         先序和后序重建二叉树：头节点为1，左子树头节点为2，左子树节点为{2, 4, 5, 8, 9}、{4, 8, 9, 5, 2}，
 *                            右子树节点为{3, 6, 7}、{6, 7, 3} ...
 * </p>
 * <p>时间复杂度为O(N)</p>
 *
