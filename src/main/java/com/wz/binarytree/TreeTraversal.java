 ...
 *          3、不断重复步骤二，直到栈空结束
 *     假设当前二叉树根节点为1，其左右孩子为2、3，2的左右孩子为4、5，3的左右孩子为6、7，分别说明以上过程
 *     非递归先序遍历：
 *          stack：1  2,3  4,5,3  5,3  3  6,7  7
 *          print：1   2     4     5   3   6   7
 *     非递归中序遍历：
 *          stack：1  2,1  4,2,1  2,1  5,1  1  3  6,3  3  7
 *          print：          4     2    5   1      6   3  7
 *     非递归后序遍历方案一：
 *          stack：1  3,2  7,6,2  6,2  2  5,4  4
 *          print：1   3     7     6   2   5   4
 *     非递归后序遍历方案二：
 *          stack：1  2,1  4,2,1  2,1  5,2,1  2,1  3,1  6,3,1  3,1  7,3,1  3,1  1
 *          print：          4           5     2          6           7     3   1
 * </p>
 *
 * @author wangzi
